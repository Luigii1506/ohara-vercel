...
import BracketOverlayClient from "@/components/live-overlay/BracketOverlayClient";
import {
  getLiveOverlayToken,
...
export default function BracketOverlayPage({ params }: BracketPageProps) {
  ...
  return <BracketOverlayClient token={params.token} />;
}
