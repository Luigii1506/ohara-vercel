...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-[calc(100%-2rem)] max-w-sm rounded-2xl border-none bg-white p-6 shadow-2xl sm:max-w-md sm:rounded-3xl sm:p-8">
        ...
        <DialogHeader className="space-y-2 pt-2">
          <DialogTitle className="text-xl font-bold text-slate-900 text-center sm:text-2xl">
            Bienvenido a OharaTCG
          </DialogTitle>
