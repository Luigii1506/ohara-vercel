...
const SimulatorControls: React.FC<SimulatorControlsProps> = ({
  ...
  const handleExportImg = async () => {
    const el = document.getElementById("simulator-board");
    if (!el) return;
    try {
      setIsExporting(true);
      ...
      link.download = `ohara-board-turno-${turn}.png`;
    ...
    <div className="space-y-6 rounded-3xl border border-white/10 bg-black/40 p-4 lg:p-6">
      <section className="space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4">
        ...
        <div className="flex flex-wrap items-center gap-2 border-t border-white/10 pt-3">
          ...
          <Button variant="secondary" size="sm" onClick={nextTurn}>
        ...
        <div className="border-t border-white/10 pt-3">
          ...
          >
            ...
            {isExporting ? "Exportando..." : "Exportar imagen del tablero"}
          </Button>
        </div>
      </section>
