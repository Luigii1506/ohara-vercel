...
/**
 * Script para crear cartas "2nd Anniversary" en la base de datos.
 * - Hace scraping de TCGplayer para el set "Emperors in the New World 2nd Anniversary Tournament Pack".
 * - Busca la carta base (isFirstEdition: true) por código y crea una alterna con alternateArt="2nd Anniversary".
 * - Sube las variantes de imagen a R2 y relaciona la carta con el set objetivo.
 *
 * Uso:
 *   npx ts-node scripts/process-anniversary-set-2nd.ts --maxPages=4
 */
...
const TARGET_SET_TITLE =
  "Emperors in the New World 2nd Anniversary Tournament Pack";
const ALTERNATE_ART_LABEL = "2nd Anniversary";
...
async function main() {
  console.log(`Processing 2nd Anniversary set pages=${cli.maxPages}`);
