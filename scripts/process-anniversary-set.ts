...
/**
 * Script para crear cartas "1st Anniversary" en la base de datos.
 * - Hace scraping de TCGplayer para el set "Awakening of the New Era: 1st Anniversary Tournament Pack".
 * - Busca la carta base (isFirstEdition: true) por código y crea una alterna con alternateArt="1st Anniversary".
 * - Sube las variantes de imagen a R2 y relaciona la carta con el set objetivo.
 *
 * Uso:
 *   npx ts-node scripts/process-anniversary-set.ts --maxPages=4
 */
...
const TARGET_SET_TITLE =
  "Awakening of the New Era: 1st Anniversary Tournament Pack";
const ALTERNATE_ART_LABEL = "1st Anniversary";
...
async function main() {
  console.log(
    `Processing 1st Anniversary set pages=${cli.maxPages}`
  );
